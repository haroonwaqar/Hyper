 ...
 */
async function checkHyperliquidConnectivity() {
    const result = {
 ...
 */
async function checkControlLogic() {
    const result = {
    ...
    try {
        ...
        const strategySwitchTest = (currentStrategy) => {
 ...
 */
async function checkWithdrawalReadiness() {
    const result = {
 ...
 */
async function checkEngineDryRun() {
    const result = {
    ...
    try {
        ...
        const momentumTest = (currentPrice, previousPrice) => {
